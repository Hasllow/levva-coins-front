...
import GetCategoriesUseCase from '../../useCases/GetCategoryUseCase/GetCategoryUseCase';
...
export const TransactionModal = () => {
  ...
  const handleCreateTransaction = async ({ description, amount, type, categoryId }: FormProps) => {
